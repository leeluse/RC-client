...
const Nav = ({}) => {
  ...
  return (
    ...
    <div className='fixed bg-white min-w-full h-[120px] flex items-center 
      ...
      <div className='sm:w-2/3 lg:w-2/3 flex items-center justify-between px-2'>
        {/*  홈 로고 */}
        ...
        {/*  검색창 */}
        <div className='md:min-w-1/3 lg:w-[400px] mx-5 rounded-md bg-slate-200 flex justify-between lg:mr-[110px]'>
